  ...
  render() {
    return (
      <div className='form'>
        ...
        <label htmlFor='type' className='form__label'>Escolha um tipo de investimento: </label>
        <select
        ...
        <label htmlFor='date' className='form__label'>Duração do investimento: </label>
        <select
          className='custom-select form__select col-8 col-sm-3'
          id='date'
        ...
        <label htmlFor='amount' className='form__label'>Volume do aporte inicial (em R$): </label>
        <select
          className='custom-select form__select col-8 col-sm-3'
          id='amount'
